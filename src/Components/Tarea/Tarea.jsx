...
export default function TodoListApp() { // Define un componente funcional llamado TodoListApp y lo exporta como componente principal
  ...
  return ( // Retorna la interfaz de usuario del componente TodoListApp
    <div className={styles.container}>
      <h1>To-Do List</h1>
      <AgregarTarea onAddTask={addTask} /> {/* Renderiza el nuevo componente AgregarTarea y pasa la función addTask como prop */}

      <BuscadorTareas value={searchText} onChange={setSearchText} /> {/* Renderiza el nuevo componente BuscadorTareas y pasa el texto de búsqueda y setSearchText como props */}
